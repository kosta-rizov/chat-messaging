...
export const Icons = {
  ...
  UserPlus,
  LoginLogo : (props: LucideProps) => (
    <svg  {...props} viewBox="0 0 24 24" fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
      <path 
        d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/>
    </svg>
  )
};
